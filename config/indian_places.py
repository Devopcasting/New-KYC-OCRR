indian_states_cities = ['haryana',"faridabad","gurgaon","hisar","rohtak","panipat","karnal","sonipat","yamunanagar","panchkula","bhiwani","bahadurgarh","jind","sirsa","thanesar","kaithal","palwal","rewari","hansi","narnaul","fatehabad","gohana","tohana","narwana","mandi Dabwali","charkhi Dadri","shahbad","pehowa","samalkha","pinjore","ladwa",
"sohna","safidon","taraori","mahendragarh","ratia","rania","sarsod","tamil nadu","chennai","coimbatore","madurai","tiruchirappalli","salem","tirunelveli","tiruppur","ranipet","nagercoil","thanjavur","vellore","kancheepuram","erode","tiruvannamalai","pollachi","rajapalayam","sivakasi","pudukkottai","neyveli (TS)","nagapattinam",
"viluppuram","tiruchengode","vaniyambadi","theni allinagaram","udhagamandalam","aruppukkottai","paramakudi","arakkonam","virudhachalam","srivilliputhur","tindivanam","virudhunagar","karur","valparai","sankarankovil","tenkasi","palani","pattukkottai","tirupathur","ramanathapuram","udumalaipettai","gobichettipalayam","thiruvarur","thiruvallur","panruti",
...
"sanduru","afzalpur","maddur","madhugiri","tekkalakote","terdal","mudabidri","magadi","navalgund","shiggaon","shrirangapattana","sindagi","sakaleshapura","srinivaspur","ron","mundargi","sadalagi","piriyapatna","adyar","Maharashtra","Mumbai","Pune","Nagpur","Thane","Nashik","Kalyan-Dombivali",
...
"Patur","Mhaswad","Loha","Nandgaon","Warud","Kamothe","Navi Mumbai","Manipur","Imphal","Thoubal","Lilong","Mayang Imphal", "Kerala","Thiruvananthapuram","Kochi","Kozhikode","Kollam","Thrissur","Palakkad","Alappuzha","Malappuram","Ponnani","Vatakara","Kanhangad","Taliparamba",
...
"Pathanamthitta","Peringathur","Attingal","Kodungallur","Pappinisseri","Chittur-Thathamangalam","Muvattupuzha","Adoor","Mavelikkara","Mavoor","Perumbavoor","Vaikom","Palai","Panniyannur","Guruvayoor","Puthuppally","Panamattom","Delhi","New Delhi","Puducherry","Pondicherry",
...
"Firozabad","Agra","Meerut","Varanasi","Allahabad","Amroha","Moradabad",
    "Aligarh",
    "Saharanpur",
    "Noida",
    "Loni",
